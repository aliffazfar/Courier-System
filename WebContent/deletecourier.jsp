...
<title>Delete Courier Men | Ninja Laju</title>
</head>
<body>
<div class="top">
<header>
...
<div class="main">
 ...
 <img src="images/deletecourier-01.png" style='height: 100%; width: 100%; object-fit: contain' class="center"><br>
 <%
try{
...
%>
  ...
  <form action="deletecour" method="post">
    ...
    <input type="text"  name="courierName" value="<%=resultSet.getString("courier_name") %>" disabled></div>

	<div class="form-group name3 col-md-6">
    <label for="fname">Courier IC</label>
    <input type="text"  name="courierIC" value="<%=resultSet.getString("courier_ic") %>" disabled> </div>
   
    <label for="lname">Courier Address</label>
    <input type="text" name="courierAdd" value="<%=resultSet.getString("courier_add") %>" disabled>
    
    <div class="form-group name2 col-md-6">
	<label for="lname">Courier Phone Number</label>
    <input type="text"  name="courierPhone" value="<%=resultSet.getString("courier_phone") %>" disabled></div>

    <div class="form-group name3 col-md-6">
	<label for="lname">Courier Postcode</label>
    <input type="text"  name="courierPostcode" value="<%=resultSet.getString("courier_postcode") %>" disabled></div>
    
	<label for="courierType">Courier Type</label>
    <select  name="courierType" disabled>
