...
<title>Delete Parcel | Ninja Laju</title>
</head>
<body>
<div class="top">
<header>
...
<div class="main">
 ...
 <img src="images/deletePAR-01.png" style='height: 100%; width: 100%; object-fit: contain' class="center"><br>
 <%
try{
...
%>
  ...
  <form action="deleteparc2" method="post">
