...
<title>Pending Parcel | Ninja Laju</title>
</head>
<body>
<div class="top">
<header>
...
<div class="left">
  ...
  <a class="active" href="pending.jsp">Pending Parcel</a>
  <a href="tracking.jsp">Update Tracking ID</a>
  <a href="parcel.jsp">Out For Delivery</a>
</div>
</div>
<div class="main">
 <h2 style="text-align:center;">PENDING PARCEL</h2>
...
String sql3 ="select * from item JOIN customer ON item.cust_ic = customer.cust_ic ";
...
%>
		<tr>
			...
			<td>
			<form action="editPAR.jsp" method="post">
			...
			<input type="submit" style="background-color: #059c23;"value="Edit">
 		    ...
 		    <td>
 		    <form action="deleteparcel2.jsp" method="post">
			<input type="hidden" name="idd" value=<%=resultSet.getString("item_id") %>>
