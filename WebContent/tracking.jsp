...
<div class="main">
 ...
 <img src="images/updateTrackk-01.png" style='height: 100%; width: 100%; object-fit: contain' class="center"><br>
  ...
  <form action=tracking2.jsp method="post">
...
%>
    <select name="idd">
		...
		String item = resultSet.getString("item_id"); 
		%>
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql4 ="select * from item ORDER BY item_id ASC";
...
%>
		<tr>
			...
			<td><%=resultSet.getString("recAdd") %> </td>
