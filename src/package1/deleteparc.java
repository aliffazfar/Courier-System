...
@WebServlet(name ="R10", urlPatterns = {"/deleteparc"})
public class deleteparc extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("alert('Parcel Delivered Successfully');");  
		out.println("window.location.assign('parcel.jsp');");  
		out.println("</script>");
		} catch (Exception e2) {
